...
class BuildDataset (data.Dataset):
    ...
    def __init__(self, imgs_path, labels, extra_info=None, transform=None):
        ...
        """
#=list("C:\Users\BOLD I.T\Desktop\jedyy\pytorch\HAMDataset\HAM10000_metadata.csv")
        imgs_path=Image.open("C:/Users/BOLD I.T/Desktop/jedyy/pytorch/HAMDataset/HAMTest")
...
def get_data_loader (imgs_path, labels, extra_info=None, transform=None, params=None):
    """
    This function gets a list of images path, their labels and extra information (if it exists) and returns a DataLoader
