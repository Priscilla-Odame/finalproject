...
def get_path_from_folders(path, extra_info_suf=None, img_exts=['png'], shuf=True, seed_number=None):
    ...
    """
    path = Image.open("C:/Users/BOLD I.T/Desktop/jedyy/pytorch/HAMDataset/HAMTest")
...
def load_dataset_from_csv_legacy (csv_path, labels_name=None, extra_info_names=None, extra_info_str=None,
    ...
    """
    csv_path = np.loadtxt('C:/Users/BOLD I.T/Desktop/jedyy/pytorch/HAMDataset/HAM10000_metadata.csv', delimiter=',', dtype=np.float32, skiprows=1)
